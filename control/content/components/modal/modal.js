class Modal {
    ...
    showDialog(options, saveCallback) {
        this.btnSave = this.container.querySelector(".dialog-save-btn");
        this.btnSave.onclick = saveCallback;

        const btnCancelButton = this.container.querySelector(".dialog-cancel-btn");
        btnCancelButton.style.display = ''; // reset
        this.btnSave.style.display = ''; // reset
        this.btnSave.classList.add('btn-success'); // reset
        this.btnSave.classList.add('margin-bottom-zero'); // reset
        ...
        if (options) {
            ...
            if (options.saveText) {
                this.btnSave.innerHTML = options.saveText;
            }
            ...
            if (options.primarySaveBtn) {
                ...
                this.btnSave.classList.add('btn-primary');
            }
        }
        this.showBackdrop();
